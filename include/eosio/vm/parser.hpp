...
namespace eosio { namespace vm {
   ...
   class binary_parser {
    public:
      ...
      inline module& parse_module2(wasm_code_ptr& code_ptr, size_t sz, module& mod, detail::code_generate_mode mode = detail::code_generate_mode::use_same_allocator) {
         parse_module(code_ptr, sz, mod, mode);
         return mod;
      }

      void parse_module(wasm_code_ptr& code_ptr, size_t sz, module& mod, detail::code_generate_mode mode = detail::code_generate_mode::use_same_allocator) {
         _mod = &mod;
